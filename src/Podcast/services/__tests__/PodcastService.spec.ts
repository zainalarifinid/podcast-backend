...
describe('PodcastService', () => {
  ...
  describe('create podcast', () => {
    ...
    it('Should result untitled in title if "title" given empty string ', async done => {
      ...
      podcastRepositoryMock.save.mockResolvedValueOnce(
        exampleDataPodcast as any,
      );
      ...
      try {
        ...
        expect(podcastRepositoryMock.save).toHaveBeenCalledWith(
          exampleDataPodcast,
        );
        done();
      } catch (err) {
  ...
  describe('update podcast', () => {
    ...
    it('Should reject with HttpException if idPodcast given not exist Podcast', async done => {
      ...
      try {
        await podcastService.update(idUser, idPodcast, exampleDataPodcast);
        done('should have thrown HttpException');
      } catch (err) {
